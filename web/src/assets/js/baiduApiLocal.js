...
window.BMAP_AUTHENTIC_KEY = "OS73ksFzj9emYwMfGhC72reaYRMy7jQE";
(function() {
    function aa(a) {
        throw a;
    }
            ...
            if (e.Le == this.Bj.Np)
                ...
                if (e.Le == this.Bj.bG) {
                    ...
                    setTimeout(function() {
                        ...
                        f.gC = t;
                        f.Qd.gn.length = 0;
                        // 0 == a.length ? f.DK() : oa('../map/getModules.js')
                        //http://api.map.baidu.com/getmodules?v=3.0
                        0 == a.length ? f.DK() : oa('./static/map/getModules.js')
                    }, 1));
                    e.Le = this.Bj.xP
                }
                e.zu.push(b)
            ...
            a))
                for (var c = q, c = "2" == D.$t ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.tj[e]; e++)
                    if (f.z_ == p) {
                        ...
                        // f.getTilesUrl = function(a, b) {
                        //     var x=a.x,y=a.y,e=1,z=a;
                        //     return "D://百度地图离线//map/"+b+"/"+x+"/"+y+".png";
                        // };
                        break
                    }
        }
    ...
    function ie(a, b, c, e, f) {
        ...
        //   , w = "../map/config/" + s.substring(s.lastIndexOf('.') + 2) +'.js';
        //   debugger
          , w = "./static/map/config/" + s.substring(s.lastIndexOf('.') + 2) +'.js';
        window[y] = function(a) {
            clearTimeout(i[g].Sk);
            i[g] = q;
            if (a) {
